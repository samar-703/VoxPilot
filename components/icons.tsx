...
export function IconMicrophoneOff({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconDatabase({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconServer({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWaveform({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBookmark({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VoxPilotLogo({ size = 32, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
      ...
      />
      <path
        d="M14 24c0-5.523 4.477-10 10-10s10 4.477 10 10"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        opacity="0.5"
